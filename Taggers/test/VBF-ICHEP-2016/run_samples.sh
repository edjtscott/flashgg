...
today=`date +%F`
#outdir=/vols/cms/es811/VbfParamTests/qcd-param-third-${today}
outdir=/vols/cms/es811/VbfParamTests/gjet-${today}

#fggRunJobs.py --load qcd_samples.json -d ${outdir} \
fggRunJobs.py --load gjet_sample_ed.json -d ${outdir} \
