...
flashggTHQHadronicTag = cms.EDProducer("FlashggTHQHadronicTagProducer",
                                       ...
                                       METTag=cms.InputTag('flashggMets'),
                                       rhoTag = cms.InputTag('fixedGridRhoFastjetAll'),
                                       thqVsBkgMVAweightfile = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_tth_hadronic_2017Data_30vars_v0.weights.xml"),
                                       #thqVsTTHMVAweightfile = cms.FileInPath("flashgg/Taggers/data/Hadronic__v3.10_8Oct2019_RunII_MVA_Presel_impute_addDNNs_addTopTag__bdt.xml"),
                                       thqVsTTHMVAweightfile = cms.FileInPath("flashgg/Taggers/data/TMVAClassification_tth_hadronic_2017Data_30vars_v0.weights.xml"),
                                       MVAMethod = cms.string("BDT"),     
                                       RECOfilters = cms.InputTag('TriggerResults::RECO'),
                                       leadPhoOverMassThreshold = cms.double(0.33),
                                       leadPhoPtThreshold = cms.double(20),  
