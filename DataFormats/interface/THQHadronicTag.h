...
namespace flashgg {
    ...
    public:
        THQHadronicTag();
        THQHadronicTag( edm::Ptr<DiPhotonCandidate>, edm::Ptr<DiPhotonMVAResult>, std::vector<edm::Ptr<flashgg::Jet> >, std::vector<edm::Ptr<flashgg::Jet> > );
        THQHadronicTag( edm::Ptr<DiPhotonCandidate>, DiPhotonMVAResult, std::vector<edm::Ptr<flashgg::Jet> >, std::vector<edm::Ptr<flashgg::Jet> > );
        THQHadronicTag *clone() const override { return ( new THQHadronicTag( *this ) ); }
        ~THQHadronicTag();
        ...
        DiPhotonTagBase::tag_t tagEnum() const override {return DiPhotonTagBase::kTHQHadronic; }
